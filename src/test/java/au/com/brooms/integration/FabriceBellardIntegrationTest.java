 ...
 * @author brooms
 */
public class FabriceBellardIntegrationTest extends AbstractIntegrationTest {
  ...
  public static void setup() {
    ...
    system = ActorSystem.create("FabriceBellard");
  }
  ...
  /**
   * Test the actor system using the Fabrice-Bellard approximation
   */
  @Test
  public void testFabriceBellard() {
    new JavaTestKit(system) {{

      // Approximation method
      Approximation approximation = new FabriceBellard();
