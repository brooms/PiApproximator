 ...
 * @author brooms
 */
public class BBPIntegrationTest extends AbstractIntegrationTest {
  ...
  /**
   * Test the actor system using the Bailey-Borwein-Plouffe approximation
   */
  @Test
  public void testBaileyBorweinPlouffe() {
    new JavaTestKit(system) {{

      // Approximation method
      Approximation approximation = new BaileyBorweinPlouffe();
